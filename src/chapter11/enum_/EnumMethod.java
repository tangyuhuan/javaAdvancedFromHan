...
public class EnumMethod {
    public static void main(String[] args) {
        ...
        //从反编译可以看出 values方法，数组 Season2[]，源码中隐藏了values()
        //含有定义的所有枚举对象
        ...
        Season2 autumn1 = Season2.valueOf("AUTUMN");//没有这个常量的话报错No enum constant chapter11.enum_.Season2.HHH
         ...
         */
        System.out.println(Season2.AUTUMN.compareTo(Season2.SUMMER));//两个ordinal()相减
