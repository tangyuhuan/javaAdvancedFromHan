package chapter15.generic.improve;
...
public class Generic02 {
    public static void main(String[] args) {
        ...
        //2. 如果编译器发现添加的类型，不满足要求，就会报错，相当于加入了数据类型约束
        //3. 在遍历的时候，可以直接取出 Dog 类型而不是 Object，避免了类型转换
        //4. public class ArrayList<E> {} E称为泛型,那么在创建new ArrayList<Dog>时将Dog指定给了E
