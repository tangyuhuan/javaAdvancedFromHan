...
/**p487 大数处理方案：BigDecimal适合保存精度更高的浮点数
 * @author 韩顺平
 * @version 1.0
 */
public class BigDecimal_ {
    public static void main(String[] args) {
        ...
        System.out.println(d);//1999.11111111112 精度会丢失
        BigDecimal bigDecimal = new BigDecimal("1999.1112323232323232332");
