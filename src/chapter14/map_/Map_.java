...
public class Map_ {
    public static void main(String[] args) {
        ...
        //   只能有一个（因为key不可以重复），value 为null ,可以多个
        //6. 常用String类作为Map的 key，当然其他类型作为key也可以
        //7. key 和 value 之间存在单向一对一关系，即通过指定的 key 总能找到对应的 value （实用，例如身份证号 姓名）
        Map map = new HashMap();
        map.put("no1", "韩顺平");//k-v
        map.put("no2", "张无忌");//k-v
        map.put("no1", "张三丰");//当有相同的k , 就等价于替换.
        map.put("no3", "张三丰");//k-v，Map 中的 value 可以重复
